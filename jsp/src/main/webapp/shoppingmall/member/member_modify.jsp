...
<%-- => [회원변경] 태그를 클릭한 경우 [/shoppingmall/member/member_modify_action.jsp] 문서 요청 - 입력값(회원정보) 전달 --%>
...
<form id="join" action="<%=request.getContextPath() %>/shoppingmall/member/member_modify_action.jsp" method="post">
<fieldset>
