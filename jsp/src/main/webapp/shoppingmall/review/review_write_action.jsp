...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 게시글(새글 또는 답글)을 전달받아 REVIEW 테이블에 삽입하고 [/shoppingmall/review/review_list.jsp] 문서로
...
<%
	...
	//페이지 이동
	response.sendRedirect(request.getContextPath()+"/shoppingmall/index.jsp?group=review&worker=review_list&pageNum="+pageNum);
%>