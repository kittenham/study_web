...
<%
	...
	StudentDTO sdDto = (StudentDTO)session.getAttribute("student");
	if(sDto!==null){
	...
	<table align="center" border="1" cellpadding="1" cellspacing="0" width="300">
		<tr height="40">
			...
			<td width="200" align="center">
				<input type="text" name="no" <% if(sDto!=null) { %>value="<%=student.getNo() %>"<% } %>>
		...
		<tr height="40">
			...
			<td width="200" align="center">
				<input type="text" name="name"<% if(sDto!=null) { %>value="<%=student.getName() %>"<% } %>>
			</td>
		</tr>
		<tr height="40">
			<th bgcolor="yellow" width="100">전화번호</th>
			<td width="200" align="center">
				<input type="text" name="phone"<% if(sDto!=null) { %>value="<%=student.getPhone() %>"<% } %>>
			</td>
		</tr>
		<tr height="40">
			<th bgcolor="yellow" width="100">주소</th>
			<td width="200" align="center">
				<input type="text" name="address"<% if(sDto!=null) { %>value="<%=student.getAddress() %>"<% } %>>
			</td>
		</tr>
		<tr height="40">
			<th bgcolor="yellow" width="100">생년월일</th>
			<td width="200" align="center">
				<input type="text" name="birthday"<% if(sDto!=null) { %>value="<%=student.getBirthday() %>"<% } %>>
			</td>
		</tr>
		<tr height="40">
