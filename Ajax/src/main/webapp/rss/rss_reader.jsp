...
<body>
	...
	$.ajax({
		...
		//url: "https://www.khan.co.kr/rss/rssdata/kh_sports.xml", //경향신문 스포츠 기사 RSS 서비스
		url: "rss_proxy.jsp",
		...
		success: function(xmlDoc) {
			...
			$(xmlDoc).find("item").each(function() {
				...
				if($(this).find("pubDate").length!=0){
					...
					date=$(this).find("dc\\:date").text(); //name space(dc)안에 있는 tag(date)를 구별하기위해 :앞에 \\두 개 적어서 \인식시켜줌
				}
