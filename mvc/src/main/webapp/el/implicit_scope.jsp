...
<%
	...
	session.setAttribute("sessionName", "전우치");//Session Scope //클라이언트가 같다.(같은 세션을 바인딩한)
	application.setAttribute("applicationName", "일지매");//Application Scope //WAS가 같다. (session과 application은 엄연히 다름)
	...
	pageContext.setAttribute("name", "홍경례");//Page Scope //=>이 내장객체에는 홍길동은 지워지고 홍경례가 저장됨.
